...
class InvalidCredentials extends Unauthorized {
	...
	public static function error() {
		...
		$error->message = \Processwire\__('The credentials you gave were not valid');
		$error->info = \Processwire\__('User or password were incorrect or wrong format of params.');
